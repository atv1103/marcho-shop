$(function () {
    ...
    $('.shop__filter-iconbtn').on('click', function(){
        $('.shop__filters').slideToggle();
    });

    $(".select-style, .product-card__num").styler()
    ...
    async function initMap() {
        ...
        map = new Map(document.getElementById("map"), {
            center: { lat: 40.7106446628959, lng: -74.01205041692607 },
            zoom: 13,
            //www.snazzymaps.com
            styles: [
                {
